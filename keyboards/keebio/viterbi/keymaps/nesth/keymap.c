 ...
 */
  [_QWERTY] = LAYOUT_ortho_5x14(
    ...
    KC_EQL,  ARROWS , KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,     KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_ENT ,
    KC_COPY, KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,     KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT, KC_DEL ,
    KC_PSTE, ADJUST , KC_LCTL, KC_LALT, KC_LGUI, LOWER  , KC_SPC ,     KC_SPC , RAISE  , KC_PGUP, KC_PGDN, KC_HOME, KC_END , KC_BSLS
  ),
