...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LCTL, KC_LALT, ADJUST,  KC_LGESC,LOWER,   KC_SPC , KC_ENT,  RAISE, KC_RACL,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_LSFT, KC_NO,   KC_BTN2, KC_WH_D, KC_WH_U, KC_BTN1,KC_LPRN,KC_RPRN,KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_NO,   KC_NO, \
      KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_LGESC,LOWER,  KC_SPC, KC_ENT, RAISE,   KC_RACL, KC_NO,   KC_NO,   KC_NO,   KC_NO \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_LSFT, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD, \
      _______, _______, _______, _______, KC_LGUI, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RALT, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      RESET,   RGBRST,  _______, _______, _______, _______,                   _______, KC_MUTE, _______, _______, _______, KC_DEL, \
      RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, _______,                   KC_PAUSE, KC__VOLUP, _______, _______,  _______, _______, \
      RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, _______, _______, _______, _______, _______, _______, _______, _______, RGB_RMOD, \
      _______, _______, _______, _______, KC_LGUI, LOWER,   KC_SPC,  KC_ENT,  RAISE, KC_RALT, _______, _______, _______, _______ \
      )
};
